...
INSTALL_DIR_BASE_BASE :: (claire_prefix / "claire")

INSTALL_DIR_BASE :: (INSTALL_DIR_BASE_BASE / "claire-v" /+ release())

INSTALL_DIR :: (INSTALL_DIR_BASE / compiler.env)
...
(try
	...
	// the home dir of the install	
	if not(isdir?(INSTALL_DIR_BASE_BASE))
		mkdir(INSTALL_DIR_BASE_BASE),
	
	if not(isdir?(INSTALL_DIR_BASE))
	...
	if not(isdir?(INSTALL_DIR_BASE_BASE / "lib"))
		mkdir(INSTALL_DIR_BASE_BASE / "lib"),
