...
public/ccmain.cl: doc/index.html ./tmpclaire2 $(Dr)/ccmain.cl $(Dr)/configure $(Dr)/Makefile.in.unix $(Dr)/Makefile.in.mvs $(Dr)/init.cl $(Dr)/Makefile.nt
	@echo -------
	@echo - pub -
	@echo -------
	mkdir -p public
...
doc/index.html: tmpclaire2 meta/*.cl
	./tmpclaire2 -s 8 0 -apidoc claire -q
	mv doc/claire.html doc/index.html
