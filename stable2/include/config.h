...
/* getpeername param 2 */
#define GETPEERNAME_ARG2 struct sockaddr

/* getpeername param 3 */
#define GETPEERNAME_ARG3 socklen_t
...
/* Define if you have editline library */
#define CLEL 1
...
/* Define to 1 if you have the <socket.ext.h> header file. */
