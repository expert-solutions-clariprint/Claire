...
ClaireBoolean *insensitive_equal_string1(register char *s1, register char *s2)
{ CL_INT l1 = LENGTH_STRING(s1);
  CL_INT l2 = LENGTH_STRING(s2);
  if (l1 != l2) return CFALSE;
  CL_INT i = 0;
...
CL_INT integer_I_float_(OID n) {return integer_I_float(float_v(n));}
CL_INT integer_I_float(double n)
